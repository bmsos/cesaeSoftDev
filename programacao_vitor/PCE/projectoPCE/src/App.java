...
public class App {
    ...
    /**
     * Avalia quais os 5 jogos que deram mais lucro (+ os respetivos lucros)
     * @param vendas matriz do ficheiro vendas
     * @param categorias matriz do ficheiro categorias
     * @return String[][] top5Jogos {nome, categoria, editora, lucroTotal}
     */
    static String[][] getTop5Jogos(String[][] vendas, String[][] categorias) {
        String[][] top5Jogos = new String[5][4];    // {nome, categoria, editora, lucroJogo} * 5
        ...
        while (index < 5) { // pára quando o index chegar a 5 (a matriz de retorno está cheia)
            ...
            for (int i = 1; i< vendas.length; i++) {
                ...
                // desconsiderar jogo se ja estiver na matriz do top5
                boolean estaNoTop5 = false;
                for (String[] jogo : top5Jogos) {
                    String nomeJogoNoTop5 = jogo[0];
                    if (nomeJogo.equals(nomeJogoNoTop5)) {
                        estaNoTop5 = true;
                        break;
                    }
                }
                ...
                if (!estaNoTop5) {
                    ...
                    // apurar o jogo com maior lucro e preencher variaveis com os dados do jogo
                    if (lucroJogo > maiorLucroJogo) {
            ...
            // prencher uma posição do top5
            top5Jogos[index][0] = nome;
            top5Jogos[index][1] = categoria;
            top5Jogos[index][2] = editora;
            top5Jogos[index][3] = Double.toString(maiorLucroJogo);
            index++;
        }
     ...
     */
    static void mostrarMenuAdmin () throws IOException {
            ...
            while (opcao < 1 || opcao > 11) {
                ...
                switch (opcao) {
                    ...
                    case 9 -> {
                        ...
                        """);
                        Utils.imprimirMatriz(getTop5Jogos(vendas, categorias));
                        System.out.println("---------------------------");
                    }
                    case 10 -> {}
                    case 11 -> {
            ...
            switch (opcao) {
                case 1 -> {
                    try {
                        ...
                        System.out.println("Ocorreu um erro inesperado: " + erro2.getMessage());
                    }
                }
                case 2 -> {}
                case 3 -> sair = true;
