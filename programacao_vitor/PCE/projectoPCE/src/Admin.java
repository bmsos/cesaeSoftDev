...
public class Admin {
                ...
                switch (opcao) {
                    case 1 -> {
                        ...
                        while (opcaoConsultarFicheiros < 1 || opcaoConsultarFicheiros > 11) {
                            ...
                            String respostaConsultarFicheiros = input.nextLine();
     ...
     */
    public static boolean verificarCredenciais (String username, String password) throws FileNotFoundException {
     ...
     */
    public static double calcularTotalVendas (String[][] vendas) {
        double valorTotal = 0;
     ...
     */
    public static double calcularLucroTotal (String[][] vendas, String[][] categorias) {
        double lucro = 0;
        for (int i=1; i<vendas.length; i++) {
     ...
     */
    public static String[][] compradoresDoJogo (String nomeJogo, String[][] vendas, String[][] clientes) {
        int linhas = 0;
        for (int i=1; i<vendas.length; i++) {
     ...
     */
    public static String[] pesquisarCliente(String[][] clientes, String idCliente) {
     ...
     */
    public static String[][] melhoresClientes (String[][] vendas, String[][] clientes) {
     ...
     */
    public static String[][] jogosCompradosPorUmCliente(String idCliente, String[][] vendas) {
     ...
     */
    public static String[] melhorCategoria (String[][] vendas, String[][] categorias) {
     ...
     */
    public static String[][] getTopOrBottom5Jogos (String typeOfSearch, String[][] vendas, String[][] categorias) {
